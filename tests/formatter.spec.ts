import { TimeagoDefaultFormatter, TimeagoCustomFormatter, TimeagoIntl, IL10nsStrings } from '../lib/src/public_api';
...
describe('TimeagoFormatter', () => {
  ...
  describe('Custom', () => {
    ...
    it('should use numbers array if present', () => {
      ...
      expect(formatter.format(now - 1000 * 60 * 60 * 24 * 3)).toBe('prefixAgo three days suffixAgo');
    });
  });
});
